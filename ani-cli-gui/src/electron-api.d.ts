...
interface AniPlayApi {
  search(query: string, translationType: TranslationType, catalogProvider: CatalogProvider, aniListFirstSearch?: boolean, includeAdult?: boolean): Promise<IpcResponse<SearchResult[]>>
