/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bfcee2c468871e098c4b66b675b8f803)
// Runtime types generated with workerd@1.20260714.1 2026-07-21 nodejs_compat
interface __BaseEnv_Env {
	ROOM_CREATION_RATE_LIMIT: RateLimit;
	ROOM_JOIN_RATE_LIMIT: RateLimit;
	WATCH_TOGETHER_ROOMS: DurableObjectNamespace<import("./src/worker").WatchTogetherRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "WatchTogetherRoom";
	}
